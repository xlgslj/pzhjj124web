<template>
  <div
    ...
    <el-row style="margin-top:5px;"  ref="form1">
        <el-col :span="24">
          <el-form :inline="true" :model="queryTmp" label-width="8rem" label-suffix=":" size="mini">
            <el-row>
                <el-col :span="6">
                ...
                <el-col :span="6">
                    <el-form-item >
                      ...
                      <el-button type="primary" plain @click="add"  icon="el-icon-circle-plus-outline" :disabled="!pagefun('roleadd')">新增</el-button>                     
                    </el-form-item>
                </el-col>
            </el-row>
          </el-form>
...
export default {
  ...
  methods: {
    ...
    onQuery () {      
      ...
      this.loading = true
      this.users = []
      this.$axiosClient.call('sysmanage/qxgl/unit/getunits', 'get', {})
        .then((res) => {
          if (res.status === 1) {
            this.users = res.data
